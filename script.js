...
// Optimized function for mouse movement
...
// Close menu when a link is clicked in mobile menu
...
// Adjust track hover effects for mobile
document.querySelectorAll('.track').forEach(card => {
    const trackInner = card.querySelector('.track-inner');
